...
/* package mydocspage-0.1.0.0 */
#ifndef VERSION_mydocspage
#define VERSION_mydocspage "0.1.0.0"
#endif /* VERSION_mydocspage */
#ifndef MIN_VERSION_mydocspage
#define MIN_VERSION_mydocspage(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mydocspage */
...
#define CURRENT_COMPONENT_ID "mydocspage-0.1.0.0-inplace-mydocspage"
